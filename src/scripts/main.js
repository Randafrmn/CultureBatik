...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    batiks.forEach(batik => {
        ...
        batikCard.classList.add('card', 'batik-card', 'border', 'border-gray-200', 'dark:border-[#715335]' , 'rounded-3xl', 'overflow-hidden', 'h-full', 'bg-[#FFFFFF]', 'dark:bg-neutral-800',  'hover:scale-105', 'transition-transform', 'duration-300');
